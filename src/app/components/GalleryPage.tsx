            ...
            <div className="flex items-center gap-2 flex-wrap">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-3 py-1.5 text-[11px] font-semibold tracking-[0.15em] uppercase transition-all duration-200 focus:outline-none border ${
                    activeCategory===cat
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className={`${isRtl?"pr-9 pl-4":"pl-9 pr-4"} py-2 bg-white border border-[#D4AF37]/25 focus:border-[#D4AF37]/60 text-sm text-[#1C2B3A] placeholder-[#9CA3AF] outline-none w-48 transition-colors duration-200`}
                  style={{ fontFamily:"'Montserrat', sans-serif" }}
                />
              </div>
              <div className="flex border border-[#D4AF37]/25 overflow-hidden">
                <button
      ...
      {lightboxItem && lightboxIndex !== null && (
        ...
        >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 flex items-center justify-center text-white/60 hover:text-[#D4AF37] hover:bg-[#D4AF37]/10 border border-white/20 hover:border-[#D4AF37]/50 transition-all duration-200 focus:outline-none"
            aria-label={ui.prev}
          >
          ...
          {/* Content */}
          <div className="relative z-10 flex flex-col items-center gap-4 max-w-5xl w-full px-16 max-h-[92vh]">
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 flex items-center justify-center text-white/60 hover:text-[#D4AF37] hover:bg-[#D4AF37]/10 border border-white/20 hover:border-[#D4AF37]/50 transition-all duration-200 focus:outline-none"
            aria-label={ui.next}
          >
