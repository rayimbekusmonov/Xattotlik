...
const translations = {
  uz: {
    ...
    about: {
      ...
      p1: "Toshkent shahrida Islom Sivilizatsiyasi Markazi tarkibida faoliyat olib borayotgan Xattotlik Markazi klassik arab va islom xattotligini o'rganish, saqlash hamda kelajak avlodga yetkazishga bag'ishlangan nufuzli ta'lim va ma'rifat maskanidir.",
      p2: "Markazimizda tajribali usta-xattotlarimiz Saliev Xabibulo Ismailovich, Saliev Muxammad Xabibulaevich va jamoamiz rahbarligida talabalar ta'lim oladi, 2000 dan ortiq noyob tarixiy qo'lyozmalar asrab kelinadi hamda amaliy restavratsiya ishlari olib boriladi.",
      prominent: "Yetakchi usta-xattotlarimiz",
      specialties: {
        saliev1: "Saliev Xabibulo Ismailovich — Sulus, Nasx va Kufiy xatlari",
        saliev2: "Saliev Muxammad Xabibulaevich — Devoniy, Devoniy Jaliy va Sulus xatlari",
        xakberdiev: "Xakberdiev Gafurjon — Nasx va Nastaliq xatlari",
        saliev3: "Saliev Mujoxid — Sulus, Nastaliq va Riq'a xatlari",
        subxanova: "Subxanova Kamola — Oltin suvi yuritish va tazhib san'ati",
        toirov: "Toirov Oybek — Nastaliq va qadimiy manbalar restavratsiyasi",
      },
    ...
    courses: {
      ...
      fee: "Dastur narxi",
      register: "Bepul ro'yxatdan o'ting",
      features: {
    ...
    testimonials: {
      ...
      items: [
        {
          text: "Markaz arab yozuvi haqidagi tasavvurimni butunlay o'zgartirdi. Saliev Xabibulo ustozning sabri va mahorati tengsiz. Mening Nasx yozuvim to'rt oy ichida o'n barobar yaxshilandi.",
        ...
        {
          text: "Zarhal berish master-klassi hayotimni o'zgartirgan tajriba bo'ldi. Yakuniy ko'rgazma ustida taniqli ustozlar bilan birga ishlash mening ijodiy faoliyatimning eng yorqin lahzasi bo'ldi.",
    ...
    team: {
      ...
      members: [
        {
          name: "Saliev Xabibulo Ismailovich",
          role: "Bosh mudarrir va xattotlik direktori",
          specialty: "Sulus, Nasx va Kufiy xatlari",
          bio: "Klassik islom xattotligi va muqaddas bitiklar sohasida ko'p yillik tajribaga ega yetuk usta-xattot.",
        },
        {
          name: "Saliev Muxammad Xabibulaevich",
          role: "Katta o'qituvchi va xattot-ustoz",
          specialty: "Devoniy, Devoniy Jaliy va Sulus xatlari",
          bio: "Murakkab devoniy va sulus xatlari kompozitsiyalari bo'yicha mahoratli usta-xattot.",
        },
        {
          name: "Xakberdiev Gafurjon",
          role: "Xattot-ustoz va ilmiy tadqiqotchi",
          specialty: "Nasx va Nastaliq xatlari",
          bio: "Qur'oniy matnlar va nasx yozuvi bo'yicha mutaxassis, an'anaviy xattotlik qoidalarining bilimdoni.",
        },
        {
          name: "Saliev Mujoxid",
          role: "Xattot-ustoz va grafik kompozitsiyalar ustasi",
          specialty: "Sulus, Nastaliq va Riq'a xatlari",
          bio: "Xattotlik san'atida zamonaviy va mumtoz yondashuvlarni uyg'unlashtiruvchi mahoratli usta.",
        },
        {
          name: "Subxanova Kamola",
          role: "Zarhal berish va miniatyura san'ati ustasi",
          specialty: "Oltin suvi yuritish va tazhib san'ati",
          bio: "Tabiiy oltin pigmentlari va an'anaviy tazhib (zarhallash) san'ati bo'yicha tajribali mutaxassis.",
        },
        {
          name: "Toirov Oybek",
          role: "Xattot va qo'lyozmalar restavratsiyasi ustasi",
          specialty: "Nastaliq va qadimiy manbalar restavratsiyasi",
          bio: "Tarixiy qo'lyozmalarni asrash, qayta tiklash hamda Markaziy Osiyo xattotlik merosini o'rganuvchi usta.",
        },
      ],
    },
    authorPage: {
  ...
  en: {
    ...
    about: {
      ...
      p1: "Operating under the Center of Islamic Civilization in Tashkent, our Calligraphy Center stands as an internationally renowned academy dedicated to studying, preserving, and advancing classical Arabic and Islamic scripts.",
      p2: "Led by master calligraphers Saliev Khabibullo Ismailovich, Saliev Muhammad Khabibullaevich, and our faculty, our center educates art lovers and students from across the globe, maintaining an active archive of historic manuscripts and conducting expert restoration.",
      prominent: "Prominent Master Faculty",
      specialties: {
        saliev1: "Saliev Khabibullo Ismailovich — Thuluth, Naskh & Kufic Master",
        saliev2: "Saliev Muhammad Khabibullaevich — Diwani Jali & Thuluth Scripts",
        xakberdiev: "Khakberdiev Gafurjon — Naskh & Nastaliq Scripts",
        saliev3: "Saliev Mujahid — Thuluth, Nastaliq & Riq'a Scripts",
        subkhanova: "Subkhanova Kamola — Tezhib & Gold Leaf Illumination",
    ...
    testimonials: {
      ...
      items: [
        {
          text: "The Center completely transformed my understanding of Arabic script. Master Saliev Khabibullo's patience and mastery are unparalleled. My Naskh improved tenfold in just four months.",
        ...
        {
          text: "The illumination masterclass was a life-changing experience. Working alongside master calligraphers on the final exhibition was the highlight of my artistic career.",
    ...
    team: {
      ...
      members: [
        {
          name: "Saliev Khabibullo Ismailovich",
          role: "Head Master & Calligraphy Director",
          specialty: "Thuluth, Naskh & Kufic Scripts",
          bio: "Distinguished master calligrapher with extensive expertise in classical Islamic scripts and sacred manuscripts.",
        },
        {
          name: "Saliev Muhammad Khabibullaevich",
          role: "Senior Instructor & Calligraphy Master",
          specialty: "Diwani, Diwani Jali & Thuluth Scripts",
          bio: "Expert in complex calligraphic compositions and royal chancellery script design.",
        },
        {
          name: "Khakberdiev Gafurjon",
          role: "Calligraphy Instructor & Researcher",
          specialty: "Naskh & Nastaliq Scripts",
          bio: "Specialist in Quranic text legibility, Naskh syntax, and classical Central Asian script rules.",
        },
        {
          name: "Saliev Mujahid",
          role: "Calligraphy Master & Graphic Artist",
          specialty: "Thuluth, Nastaliq & Riq'a Scripts",
          bio: "Master blending classical execution with refined aesthetic compositions.",
        },
        {
          name: "Subkhanova Kamola",
          role: "Master of Illumination & Miniature Art",
          specialty: "Tezhib & Gold Leaf Illumination",
          bio: "Expert in natural gold pigments, traditional paper processing, and classic Tezhib illumination.",
        },
        {
          name: "Toirov Oybek",
          role: "Master Calligrapher & Manuscript Conservator",
          specialty: "Nastaliq & Manuscript Restoration",
          bio: "Dedicated calligrapher and manuscript conservator preserving historical Central Asian codices.",
        },
      ],
    },
    authorPage: {
  ...
  ru: {
    ...
    about: {
      ...
      p1: "Действующий в составе Центра исламской цивилизации в Ташкенте, наш Центр каллиграфии является ведущим академическим институтом, посвященным изучению, сохранению и развитию классической арабской и исламской письменности.",
      p2: "Под руководством нашей команды мастеров — Салиева Хабибулло Исмаиловича, Салиева Мухаммада Хабибуллаевича и коллег — Центр обучает студентов со всего мира, хранит архив из 2000+ древних рукописей и ведет научную реставрацию.",
      prominent: "Выдающиеся мастера нашего центра",
      specialties: {
        saliev1: "Салиев Хабибулло Исмаилович — Шрифты Сулюс, Насх и Куфи",
        saliev2: "Салиев Мухаммад Хабибуллаевич — Шрифты Дивани, Дивани Джали и Сулюс",
        xakberdiev: "Хакбердиев Гафуржон — Шрифты Насх и Насталик",
        saliev3: "Салиев Муджахид — Шрифты Сулюс, Насталик и Рика",
        subxanova: "Субханова Камола — Тазхиб и сусальное золото",
        toirov: "Тоиров Ойбек — Насталик и реставрация рукописей",
      },
    ...
    testimonials: {
      ...
      items: [
        {
          text: "Центр полностью изменил мое понимание арабской письменности. Терпение и мастерство мастера Салиева Хабибулло не имеют равных. Мой насх улучшился в десять раз всего за четыре месяца.",
        ...
        {
          text: "Мастер-класс по иллюминированию изменил мою жизнь. Совместная работа над финальной выставкой с мастерами каллиграфии стала вершиной моей творческой карьеры.",
    ...
    team: {
      ...
      members: [
        {
          name: "Салиев Хабибулло Исмаилович",
          role: "Главный мастер и директор по каллиграфии",
          specialty: "Шрифты Сулюс, Насх и Куфи",
          bio: "Выдающийся мастер каллиграфии с многолетним опытом преподавания классических исламских шрифтов.",
        },
        {
          name: "Салиев Мухаммад Хабибуллаевич",
          role: "Старший преподаватель и мастер каллиграфии",
          specialty: "Шрифты Дивани, Дивани Джали и Сулюс",
          bio: "Мастер сложных каллиграфических композиций и искусных рукописных шрифтов.",
        },
        {
          name: "Хакбердиев Гафуржон",
          role: "Преподаватель каллиграфии и исследователь",
          specialty: "Шрифты Насх и Насталик",
          bio: "Специалист по каллиграфии коранических текстов и классическим среднеазиатским канонам.",
        },
        {
          name: "Салиев Муджахид",
          role: "Мастер каллиграфии и графических композиций",
          specialty: "Шрифты Сулюс, Насталик и Рика",
          bio: "Мастер, гармонично сочетающий классические каллиграфические каноны и изящную эстетику.",
        },
        {
          name: "Субханова Камола",
          role: "Мастер золочения и миниатюры",
          specialty: "Тазхиб и сусальное золото",
          bio: "Специалист по работе с натуральным золотом, традиционной бумагой и изящным орнаментом Тазхиб.",
        },
        {
          name: "Тоиров Ойбек",
          role: "Мастер каллиграфии и реставратор рукописей",
          specialty: "Насталик и реставрация рукописей",
          bio: "Опытный специалист по реставрации древних рукописей и хранению наследия восточной каллиграфии.",
        },
      ],
    },
    authorPage: {
  ...
  ar: {
    ...
    about: {
      ...
      p1: "تأسس مركز الخط العربي تحت رعاية مركز الحضارة الإسلامية في طشقند، ويعد أحد أبرز المراكز العلمية المكرسة لدراسة الخطوط العربية والإسلامية الكلاسيكية وحفظها وتطويرها.",
      p2: "تحت إشراف نخبة من كبار الخطاطين والأساتذة، صاليف حبيب الله إسماعيلوفيتش وصاليف محمد حبيب الله يوفيتش وأعضاء الفريق، يدرّس المركز الطلاب والباحثين مع حفظ أرشيف يضم أكثر من 2000 مخطوطة تاريخية.",
      prominent: "أبرز أساتذة الخط العربي",
      specialties: {
        saliev1: "صاليف حبيب الله إسماعيلوفيتش — خطوط الثلث والنسخ والكوفي",
        saliev2: "صاليف محمد حبيب الله يوفيتش — خطوط الديواني الجلي والثلث",
        xakberdiev: "خاقبيردييف غفورجون — خطوط النسخ والتعليق",
        saliev3: "صاليف مجاهد — خطوط الثلث والتعليق والرقعة",
        subxanova: "سبخانوفا كامولا — فن التذهيب والزخرفة الإسلامية",
        toirov: "طاهروف أيبك — خط التعليق وترميم المخطوطات",
      },
    ...
    testimonials: {
      ...
      items: [
        {
          text: "لقد غيّر المركز مفهومي تماماً عن الحرف العربي. إن صبر الأستاذ صاليف حبيب الله ومهارته لا مثيل لهما. لقد تحسن خط النسخ لدي عشرة أضعاف في أربعة أشهر فقط.",
        ...
        {
          text: "كان درس تذهيب المخطوطات تجربة غيرت حياتي الفنية. العمل إلى جانب كبار أساتذة الخط في المعرض الختامي كان أبرز محطات مسيرتي الفنية.",
    ...
    team: {
      ...
      members: [
        {
          name: "صاليف حبيب الله إسماعيلوفيتش",
          role: "كبير المعلمين ومدير قسم الخط العربي",
          specialty: "خطوط الثلث والنسخ والكوفي",
          bio: "أستاذ وخبير خط عربي متميز يتمتع بخبرة واسعة في تدريس الخطوط الإسلامية الكلاسيكية.",
        },
        {
          name: "صاليف محمد حبيب الله يوفيتش",
          role: "أستاذ مشارك وخبير الخط العربي",
          specialty: "خطوط الديواني والديواني الجلي والثلث",
          bio: "أستاذ متخصص في تراكيب الخط الديواني والثلث وتصميم اللوحات الفنية المعقدة.",
        },
        {
          name: "خاقبيردييف غفورجون",
          role: "أستاذ الخط والباحث العلمي",
          specialty: "خطا النسخ والتعليق (النسعليق)",
          bio: "متخصص في ضبط النصوص القرآنية وخط النسخ والدراسات الكلاسيكية في خطوط آسيا الوسطى.",
        },
        {
          name: "صاليف مجاهد",
          role: "أستاذ الخط واللوحات الجرافيكية",
          specialty: "خطوط الثلث والتعليق والرقعة",
          bio: "أستاذ يجمع بين التكنيك الكلاسيكي والتركيب الجمالي المعاصر في خطوط الثلث والرقعة.",
        },
        {
          name: "سبخانوفا كامولا",
          role: "أستاذة التذهيب والزخرفة الإسلامية",
          specialty: "فن التذهيب والزخرفة بالذهب",
          bio: "خبيرة متخصصة في التذهيب التقليدي بالذهب الخالص ومعالجة الورق اليدوي والزخرفة الإسلامية.",
        },
        {
          name: "طاهروف أيبك",
          role: "أستاذ الخط وخبير ترميم المخطوطات",
          specialty: "خط التعليق وترميم المخطوطات التاريخية",
          bio: "خبير متخصص في ترميم المخطوطات القديمة وتوثيق التراث الخطاطي العريق في آسيا الوسطى.",
        },
      ],
    },
    authorPage: {
